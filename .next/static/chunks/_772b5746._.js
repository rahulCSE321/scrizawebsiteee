...
function FreeTrialPopup({ isPopupOpen, setIsPopupOpen }) {
    _s();
    const [hasBeenDismissed, setHasBeenDismissed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FreeTrialPopup.useEffect": ()=>{
            // Check if popup has been dismissed before
            const dismissed = localStorage.getItem('freeTrialPopupDismissed');
            if (dismissed === 'true') {
                setHasBeenDismissed(true);
                return;
            }
            // Show popup only once after 4 seconds if not dismissed before
    ...
    const closePopup = ()=>{
        ...
        localStorage.setItem('freeTrialPopupDismissed', 'true');
    };
    // Don't show if dismissed or not open
    if (!isPopupOpen || hasBeenDismissed) return null;
...
_s(FreeTrialPopup, "bNa4eGV1MQDEyyB76Pwc7l2lYAQ=");
_c = FreeTrialPopup;
var _c;
